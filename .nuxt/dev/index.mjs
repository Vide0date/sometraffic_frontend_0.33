globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/vue/server-renderer/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/radix3/dist/index.mjs';
import axios from 'file:///Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/node_modules/axios/index.js';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false},"/f/:id":{"ssr":true},"/logins/**":{"ssr":false},"/dashboard/**":{"ssr":false},"/users/**":{"ssr":false},"/category-items/**":{"ssr":false},"/information-items/**":{"ssr":false},"/tasks/**":{"ssr":false},"/tracking-url/**":{"ssr":false},"/emails/**":{"ssr":false},"/click-list/**":{"ssr":false},"/user-groups/**":{"ssr":false},"/redirecting/**":{"ssr":false},"/**":{"ssr":false}}},"public":{"BASE_URL":"https://sometraffic.com","API_BASE_URL":"https://backend.sometraffic.com/api/"}};
...
const serverAssets = [{"baseName":"server","dir":"/Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_YvWvad = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('/Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/maheshvagicherla/Downloads/upwork/sometraffic/sometraffic-frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>SomeTraffic Global</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"description\" content=\"SomeTraffic Nuxt App,  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi vero, rem dolorem voluptatem sapiente veritatis perspiciatis architecto iusto iste delectus natus ad ut a quisquam. Ad qui et debitis sequi.\">\n<meta property=\"fb:app_id\" content=\"1477435389326991\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};

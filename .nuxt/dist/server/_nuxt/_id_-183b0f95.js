...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--><button class="text-center cursor-pointer">+ Add a group</button><hr><button class="text-center cursor-pointer">View groups list</button></div></div></div></div><div class="flex flex-row py-2"><div class="basis-1/4 flex items-center text-sm font-medium text-gray-700"> Priority * <svg${ssrRenderAttrs(mergeProps({
        xmlns: "http://www.w3.org/2000/svg",
        fill: "none",
        viewBox: "0 0 24 24",
        "stroke-width": "1.5",
...
//# sourceMappingURL=_id_-183b0f95.js.map

  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(projects), (project, index) => {
        _push(`<div class="flex flex-col gap-y-2"><button type="button">${ssrInterpolate(project.name)}</button><hr class="${ssrRenderClass({ "border-black": index + 1 === unref(projects).length })}"></div>`);
      });
      _push(`<!--]--><button type="button" class="text-center cursor-pointer">+ Add a project</button><hr><button type="button" class="text-center cursor-pointer">View projects list</button></div></div></div></div><div class="flex flex-row py-2 mt-4"><div class="basis-1/4 flex items-center text-sm font-medium text-gray-700"> Group * <svg${ssrRenderAttrs(mergeProps({
        xmlns: "http://www.w3.org/2000/svg",
        fill: "none",
        viewBox: "0 0 24 24",
        "stroke-width": "1.5",
...
//# sourceMappingURL=_id_-19fc4df9.js.map

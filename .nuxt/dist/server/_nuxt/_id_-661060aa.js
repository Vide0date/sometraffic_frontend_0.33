import { H as Head, T as Title, M as Meta } from "./components-9cbfa05a.js";
...
import "./composables-b654975a.js";
import "ofetch";
      ...
      if (query.fbclid) {
        ...
        [__temp, __restore] = withAsyncContext(() => useFetch(`${config.API_BASE_URL}trackingurl/redirect`, {
          ...
          body: {
            id: params.id,
            tracking_url: fullpath,
            screen_resolution: "unknownxunknown",
            network_speed: "",
          ...
          if (result.data.value) {
            ...
            let destination2 = result.data.value.destination_url;
            if (!destination2.includes("http") || !destination2.includes("http")) {
              destination2 = "https://" + destination2;
            }
          }
          if (result.error.value) {
            console.log("Error no result", result.error);
...
//# sourceMappingURL=_id_-661060aa.js.map

...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    if (params.id && params.id.length === 7) {
      ...
      let screenHeight = 0;
      if (process.browser) {
        screenWidth = (_a = window == null ? void 0 : window.screen) == null ? void 0 : _a.width;
        screenHeight = (_b = window == null ? void 0 : window.screen) == null ? void 0 : _b.height;
      }
      let network_speed = "";
...
//# sourceMappingURL=_id_-c4949961.js.map

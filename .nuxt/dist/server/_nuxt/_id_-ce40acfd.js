import { a as useRoute, u as useRuntimeConfig, _ as _export_sfc, f as __nuxt_component_0 } from "../server.mjs";
import { _ as _imports_0, a as _sfc_main$2, b as _sfc_main$3, c as _sfc_main$4, d as _sfc_main$5 } from "./TasksHistory-1f72d154.js";
import { useSSRContext, inject, ref, unref, isRef, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, toRefs, withAsyncContext, reactive, resolveDirective, mergeProps } from "vue";
import { u as useFetch } from "./fetch-707280a9.js";
import "destr";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrGetDirectiveProps, ssrIncludeBooleanAttr, ssrLooseEqual } from "vue/server-renderer";
import moment from "moment-timezone";
import { Modal } from "usemodal-vue3";
import { _ as _imports_0$1 } from "./loading-aeba0513.js";
import "ofetch";
...
import "sweetalert2";
import "ohash";
const InformationItems_vue_vue_type_style_index_0_scoped_129f307d_lang = "";
const __default__$1 = {
...
const _sfc_main$1 = /* @__PURE__ */ Object.assign(__default__$1, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-129f307d>`);
      _push(ssrRenderComponent(unref(Modal), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text" data-v-129f307d${_scopeId}> Are you sure? </div>`);
          } else {
            return [
      ...
      _push(`<div class="flex justify-between" data-v-129f307d><h1 class="font-bold py-4 capitalize" data-v-129f307d> Information Items (${ssrInterpolate(unref(clickdatastotal))}) </h1>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: `/information-items?id=${unref(id)}`
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img style="${ssrRenderStyle({ "width": "20px", "margin-top": "20px" })}"${ssrRenderAttr("src", _imports_0)} class="information-items" data-v-129f307d${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      _push(`</div><div class="overflow-x-auto" data-v-129f307d><table class="w-full whitespace-nowrap" data-v-129f307d><thead class="bg-black/60" data-v-129f307d><tr data-v-129f307d><th class="text-left py-3 px-2" data-v-129f307d>Info ID</th><th class="text-left py-3 px-2" data-v-129f307d>Item ID</th><th class="text-left py-3 px-2" data-v-129f307d>Information</th><th class="text-left py-3 px-2" data-v-129f307d>Category</th><th class="text-left py-3 px-2" data-v-129f307d>Posts/Month</th><th class="text-left py-3 px-2" data-v-129f307d>Date/Time</th><th class="text-left py-3 px-2" data-v-129f307d>Actions</th></tr></thead><tbody data-v-129f307d><!--[-->`);
      ssrRenderList(unref(clickdatas), (clickdata) => {
        _push(`<tr class="border-b border-gray-700" data-v-129f307d><td class="py-3 px-2" data-v-129f307d>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        _push(`</td><td class="py-3 px-2" data-v-129f307d>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        _push(`</td><td class="py-3 px-2 tooltip" data-v-129f307d>${ssrInterpolate(clickdata.information.length > 90 ? clickdata.information.slice(0, 90) + "..." : clickdata.information)}</td><td class="py-3 px-2 capitalize" data-v-129f307d>${ssrInterpolate(clickdata == null ? void 0 : clickdata.Category_Item.category)}</td><td class="py-3 px-2 capitalize" data-v-129f307d>${ssrInterpolate(clickdata == null ? void 0 : clickdata.posts_per_month)}</td><td class="py-3 px-2 capitalize" data-v-129f307d>${ssrInterpolate(formatDate(clickdata == null ? void 0 : clickdata.timestamp, "YYYY-MM-DD H:m"))}</td><td class="py-3 px-2" data-v-129f307d><div class="inline-flex items-center space-x-3" data-v-129f307d>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/information-items/${clickdata.item_id}`,
          title: "Edit",
          class: "hover:text-white"
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" data-v-129f307d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" data-v-129f307d${_scopeId}></path></svg>`);
            } else {
              return [
        ...
        _push(`<span title="Delete" class="hover:text-white" data-v-129f307d><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" data-v-129f307d><path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" data-v-129f307d></path></svg></span></div></td></tr>`);
      });
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-129f307d"]]);
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0;
      const _component_TasksAll = _sfc_main$2;
      const _component_TasksUnscheduled = _sfc_main$3;
      const _component_TasksPlanned = _sfc_main$4;
      const _component_TasksHistory = _sfc_main$5;
      ...
      _push(`</button></span></div><form><div class="overflow-hidden shadow sm:rounded-md"><div class="px-4 py-5 sm:p-6"><div class="col-span-12"><div class="grid grid-cols-12"><div class="col-span-3 flex items-center text-sm font-medium text-gray-700"> Created </div><div class="col-span-3"><input type="text"${ssrRenderAttr("value", formatDate(unref(form).createdAt, "YYYY-MM-DD HH:mm"))} class="bg-[#dddddd] h-10 py-2 px-3 text-gray-900 mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-gray-800 focus:ring-indigo-500 sm:text-sm" disabled></div></div></div><div class="col-span-12"><div class="grid grid-cols-12"><div class="col-span-3 flex items-center text-sm font-medium text-gray-700"> Item title </div><div class="col-span-9"><input placeholder="Need to enter the title or subject (obligatory)" type="text"${ssrRenderAttr("value", unref(form).item_title)} id="item_title" class="bg-[#dddddd] h-10 py-2 px-3 text-gray-900 mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-gray-800 focus:ring-indigo-500 sm:text-sm" required></div></div></div><div class="col-span-12 pt-4"><div class="grid grid-cols-12"><div class="col-span-3 w-fit flex items-center text-sm font-medium text-gray-700"> Item Url <div class="basis-1/5 flex items-center text-sm font-medium text-gray-700 pl-3"><button type="button" title="Copy Command To Clipboard"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 00-3.375-3.375h-1.5a1.125 1.125 0 01-1.125-1.125v-1.5A3.375 3.375 0 006.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0015 2.25h-1.5a2.251 2.251 0 00-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 00-9-9z"></path></svg></button><a${ssrRenderAttr("href", unref(form).url_1_link)} target="_blank" rel="noopener noreferrer" title="Open To New Tap" class="pl-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25"></path></svg></a></div></div><div class="col-span-9"><input type="text" id="url_1_link"${ssrRenderAttr("value", unref(form).url_1_link)} class="${ssrRenderClass([
        ...
        (project) => project.id === unref(form).project
      ).name : "Select project" : "Select project")}</button><span class="${ssrRenderClass([{ "rotate-180": unref(showProjectsList) }, "absolute right-3 top-1/2 -translate-y-1"])}"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="24px" height="14px" viewBox="0 0 960 560" enable-background="new 0 0 960 560" xml:space="preserve"><g id="Rounded_Rectangle_33_copy_4_1_"><path d="M480,344.181L268.869,131.889c-15.756-15.859-41.3-15.859-57.054,0c-15.754,15.857-15.754,41.57,0,57.431l237.632,238.937   c8.395,8.451,19.562,12.254,30.553,11.698c10.993,0.556,22.159-3.247,30.555-11.698l237.631-238.937   c15.756-15.86,15.756-41.571,0-57.431s-41.299-15.859-57.051,0L480,344.181z"></path></g></svg></span></div><div style="${ssrRenderStyle(unref(showProjectsList) ? null : { display: "none" })}" class="absolute overflow-y-auto max-h-96 w-3/5 top-12 z-10 flex flex-col bg-[#bcbcbc] rounded-md text-black"><!--[-->`);
...
//# sourceMappingURL=_id_-ce40acfd.js.map

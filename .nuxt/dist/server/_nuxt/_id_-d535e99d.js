...
import { _ as _imports_0, a as _sfc_main$2, b as _sfc_main$3, c as _sfc_main$4, d as _sfc_main$5 } from "./TasksHistory-5f9f1fb3.js";
...
import "sweetalert2";
import "ohash";
const InformationItems_vue_vue_type_style_index_0_scoped_85683d57_lang = "";
const __default__$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img style="${ssrRenderStyle({ "width": "20px", "margin-top": "20px" })}"${ssrRenderAttr("src", _imports_0)} class="information-items" data-v-85683d57${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--><hr><button type="button" class="text-center cursor-pointer py-4 hover:bg-slate-300">+ Add a project</button><button type="button" class="text-center cursor-pointer py-4 hover:bg-slate-300">View projects list</button></div></div></div></div><div class="flex flex-row py-2 mt-4"><div class="basis-1/4 flex items-center text-sm font-medium text-gray-700"> Group * <svg${ssrRenderAttrs(mergeProps({
        ...
        html: true
      }, void 0, { right: true })))}><path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z"></path></svg></div><div class="basis-3/4"><div id="group-selector" class="relative"><div class="rounded-md cursor-pointer relative flex bg-white p-3 w-3/5 text-black"><button type="button">${ssrInterpolate(unref(groups).length ? unref(groups).find((group) => group.id === unref(form).group) ? unref(groups).find((group) => group.id === unref(form).group).name : "select group" : "select group")}</button><span class="${ssrRenderClass([{ "rotate-180": unref(showGroupsList) }, "absolute right-3 top-1/2 -translate-y-1"])}"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="24px" height="14px" viewBox="0 0 960 560" enable-background="new 0 0 960 560" xml:space="preserve"><g id="Rounded_Rectangle_33_copy_4_1_"><path d="M480,344.181L268.869,131.889c-15.756-15.859-41.3-15.859-57.054,0c-15.754,15.857-15.754,41.57,0,57.431l237.632,238.937   c8.395,8.451,19.562,12.254,30.553,11.698c10.993,0.556,22.159-3.247,30.555-11.698l237.631-238.937   c15.756-15.86,15.756-41.571,0-57.431s-41.299-15.859-57.051,0L480,344.181z"></path></g></svg></span></div><div style="${ssrRenderStyle(unref(showGroupsList) ? null : { display: "none" })}" class="absolute overflow-y-auto max-h-96 top-12 z-10 w-3/5 flex flex-col bg-white rounded-md text-black"><!--[-->`);
      ssrRenderList(unref(groups), (group) => {
        _push(`<div class="hover:bg-slate-300 transition-colors py-4 flex cursor-pointer flex-col gap-y-2"><button type="button">${ssrInterpolate(group.name)}</button></div>`);
      });
      _push(`<!--]--><hr><button type="button" class="text-center cursor-pointer py-4 hover:bg-slate-300">+ Add a group</button><button type="button" class="text-center cursor-pointer py-4 hover:bg-slate-300">View groups list</button></div></div></div></div><div class="flex flex-row py-2"><div class="basis-1/4 flex items-center text-sm font-medium text-gray-700"> Priority * <svg${ssrRenderAttrs(mergeProps({
        xmlns: "http://www.w3.org/2000/svg",
        fill: "none",
        viewBox: "0 0 24 24",
        "stroke-width": "1.5",
...
//# sourceMappingURL=_id_-d535e99d.js.map

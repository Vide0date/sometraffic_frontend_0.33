...
import "sweetalert2";
import "ohash";
const InformationItems_vue_vue_type_style_index_0_scoped_d6238d26_lang = "";
const __default__$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img style="${ssrRenderStyle({ "width": "20px", "margin-top": "20px" })}"${ssrRenderAttr("src", _imports_0)} class="information-items" data-v-d6238d26${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
...
//# sourceMappingURL=_id_-ff083a36.js.map

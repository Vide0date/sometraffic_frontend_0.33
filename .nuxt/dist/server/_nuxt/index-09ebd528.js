import { u as useRuntimeConfig, f as __nuxt_component_0 } from "../server.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(searchdatas), (clickdata) => {
        ...
        _push(`</td><td class="py-3 px-2">${ssrInterpolate(clickdata == null ? void 0 : clickdata.device)}</td><td class="py-3 px-2">${ssrInterpolate(formatDate(clickdata == null ? void 0 : clickdata.timestamp, "YYYY-MM-DD : HH:mm"))}</td><td class="py-3 px-2">${ssrInterpolate(clickdata == null ? void 0 : clickdata.country)}</td><td class="py-3 px-2">${ssrInterpolate(clickdata == null ? void 0 : clickdata.city)}</td><td class="py-3 px-2">${ssrInterpolate(clickdata == null ? void 0 : clickdata.referrer_url)}</td></tr>`);
      });
...
//# sourceMappingURL=index-09ebd528.js.map

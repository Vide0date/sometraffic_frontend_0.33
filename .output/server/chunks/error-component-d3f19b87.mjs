...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-b434ceef.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-e10e3079.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component-d3f19b87.mjs.map
